...
This fork was created to use the latest hook technology from React >=16.8, rewritten in Typescript and to solve the performance issues, mostly unnecessary re-renders with the original module, and works with new windows and React.createPortal. Zero dependencies (besides React as peer)
